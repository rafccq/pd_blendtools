...
ModelNames = [
    '0000 Investigation Ceiling dronegun',
    '0001 Crash Site Green Drone Gun',
    '0002 Tv Screen',
    '0003 BETA Borg Crate',
    '0004 Pane of glass',
    '0005 Metal Crate',
    '0006 Metal Crate',
    '0007 Metal Crate',
    ...
    '0010 BETA Door',
    '0011 Briefcase',
    '0012 Chicago Tracer bug',
    '0013 Data Uplink',
    '0014 Nintendo Logo',
    '0015 Metal Panel',
    '0016 BETA Flag from GoldenEye',
    '0017 Area 51 Control Panel / Button',
    '0018 BETA GoldenEye Terminal',
    '0019 Area 51 Square Door (Top part)',
    '001A Area 51 Square Door (Bottom part)',
    '001B Area 51 Door (Left)',
    '001C Area 51 Door (Right)',
    '001D Area 51 Door',
    '001E Area 51 Door with glass window',
    '001F Area 51 Brown door',
    '0020 Metal Crate',
    '0021 Metal Crate (Blue tint)',
    '0022 Metal Crate (Brown tint)',
    '0023 Area 51 Hole-in-wall frame',
    '0024 Area 51 Wall you blow up (With X on)',
    '0025 Area 51 Hole-in-wall frame',
    '0026 Area 51 Wall you blow up (Laboratory side)',
    '0027 Area 51 Hole-in-wall frame (Before blown up)',
    '0028 BETA Villa Door',
    '0029 Villa Wooden door',
    '002A BETA Villa Wooden slide door',
    '002B Area 51 Hanger lift',
    '002C Area 51 Small lift from hanger',
    '002D Area 51 Storage lift 1',
    '002E Area 51 Storage lift 2',
    '002F Villa Wine Bottle (Green)',
    '0030 Villa Wine Bottle (Red)',
    '0031 Villa Wine Bottle (Red, not JUNG brand)',
    '0032 Villa Windmill propellar',
    '0033 Area 51 Elvis on hoverbed',
    '0034 BETA Multicoloured box',
    '0035 Deep Sea Door (Right)',
    '0036 Deep Sea Door (Left)',
    '0037 dataDyne Building Lift',
    '0038 dataDyne Building Roof fan',
    '0039 dataDyne Building Wall fan',
    '003A Hoverbike',
    '003B dataDyne Building Office door',
    '003C Pot plant (Rubber plant)',
    '003D Pot plant (Spider plant)',
    '003E Pot plant (Spike plant)',
    '003F dataDyne Building Window glass',
    '0040 dataDyne Building Sofa',
    '0041 dataDyne Building Armchair',
    '0042 dataDyne Building Service door',
    '0043 dataDyne Building Grating door',
    '0044 dataDyne Building Lift door',
    '0045 dataDyne Building Vertical blind',
    '0046 dataDyne Building Desk',
    '0047 dataDyne Building Desk chair',
    '0048 Changing N logo',
    '0049 Changing N logo 2',
    '004A Changing N logo 3',
    '004B Perfect Dark Logo',
    '004C Perfect Dark Logo 1',
    '004D Perfect Dark Logo 2',
    '004E Perfect Dark Logo 3',
    '004F Perfect Dark Logo 4',
    '0050 Hovercop',
    '0051 Hovermoto',
    '0052 Hovertruck',
    '0053 Hovercar',
    '0054 Hovercab',
    '0055 dataDyne Building Hole-in-tube unexploded',
    '0056 dataDyne Building Hole-in-tube frame',
    '0057 dataDyne Building Hole-in-wall unexploded',
    '0058 dataDyne Building Hole-in-wall frame',
    '0059 Blue computer',
    '005A Hovercrate',
    '005B Carrington Institute Drop ship (Villa, Defense)',
    '005C Deep Sea Door from beginning of level',
    '005D Deep Sea Lift',
    '005E Case',
    '005F dataDyne Building Cassandra\'s desk',
    '0060 Area 51 Pane of glass with yellow/black caution stripes',
    '0061 Area 51 Pane of glass with yellow/black caution stripes',
    '0062 Area 51 Table',
    '0063 BETA Area 51 Chair',
    '0064 BETA Area 51 Screen',
    '0065 Area 51 Trashcan',
    '0066 Area 51 Entrance hall desk',
    '0067 Area 51 Empty hoverbed',
    '0068 Area 51 Office divider (Peachy coloured)',
    '0069 Area 51 Bulletin board with Maian pictures',
    '006A Skedar Ruins Canyon wall after blowing up rock',
    '006B Skedar Ruins Canyon rock',
    '006C Skedar Ruins Hole-in-wall frame',
    '006D Skedar Ruins Hole-in-wall unexploded',
    '006E Skedar Ruins Door',
    '006F Attack Ship Yellow slide door',
    '0070 Attack Ship Holographic star map',
    '0071 Attack Ship Holographic star map',
    '0072 Attack Ship Hanger hull door part 1',
    '0073 Attack Ship Hanger hull door part 2',
    '0074 Attack Ship Hanger hull door part 3',
    '0075 Attack Ship Hanger hull door part 4',
    '0076 BETA Skedar fighter ship',
    '0077 Secret Skedar Army pod door (Top half)',
    '0078 Secret Skedar Army pod door (Bottom half)',
    '0079 Skedar Ruins Spinning power generator pillar',
    '007A Skedar Ruins Rolling round pillar',
    '007B Attack Ship Hanger door (Top half)',
    '007C Attack Ship Hanger door (Bottom half)',
    '007D G5 Building Slide open door with window',
    '007E G5 Building Part of fire door',
    '007F G5 Building Part of fire door',
    '0080 G5 Building Part of fire door (Middle piece)',
    '0081 G5 Building Slide open door without window',
    '0082 dataDyne Building Slide door',
    '0083 dataDyne Building Secret Door 1',
    '0084 dataDyne Building Secret door 2',
    '0085 dataDyne Building Cl Jumpship',
    '0086 Chicago Hovertaxi',
    '0087 Chicago Intro Police hovercar',
    '0088 Ravine Lift',
    '0089 BETA Investigation Door',
    '008A Investigation Secret door',
    '008B Investigation Sector One Door',
    '008C Hoverbot (Orange)',
    '008D Hoverbot (White/blue)',
    '008E Investigation Sector Two Slide-down door (Bottom half)',
    '008F Investigation Sector Two Slide-up door (Top half)',
    '0090 Investigation Slide-up door with caution sign (Top half)',
    '0091 Investigation Slide-up door with hazardous sign (Top)',
    '0092 Investigation Door with caution sign and window',
    '0093 Investigation Dr. Caroll Door',
    '0094 Investigation Sector Three Slide-up door (Top half)',
    '0095 Investigation Sector Three Door',
    '0096 Investigation Sector Three Door with window',
    '0097 dataDyne Building Extraction Hovercopter',
    '0098 Investigation Sector Four Slide-up door (Top half)',
    '0099 Investigation Slide-up door with restricted sign (Top)',
    '009A G5 Building Slide door with dataDyne logo',
    '009B G5 Building Slide door with dataDyne logo',
    '009C Laser Beam door / block',
    '009D G5 Building Vault door',
    '009E dataDyne Building Defection Intro Rope',
    '009F G5 Building Mainframe',
    '00A0 Investigation Dr. Caroll Door (Base)',
    '00A1 Investigation Dr. Caroll Door (Main)',
    '00A2 Investigation Dr. Caroll Door (Left)',
    '00A3 Investigation Dr. Caroll Door (Right)',
    '00A4 Investigation Dr.Caroll Door (Base Main)',
    '00A5 Investigation Dr. Caroll Door (Base Left)',
    '00A6 Investigation Dr. Caroll Door (Base Right)',
    '00A7 dataDyne Building Rooftop banner',
    '00A8 G5 Building Upper hole-in-wall unexploded',
    '00A9 G5 Building Upper hole-in-wall frame',
    '00AA G5 Building Lower hole-in-wall unexploded',
    '00AB G5 Building Lower hole-in-wall frame',
    '00AC Chicago Dumpster',
    '00AD Chicago Unopened fire door',
    '00AE Chicago Metal shutter',
    '00AF Security Camera',
    '00B0 Communications Hub',
    '00B1 dataDyne Building Rocket Launcher stand',
    '00B2 Blue computer terminal',
    '00B3 Red grate/panel',
    '00B4 Investigation Lift',
    '00B5 Light switch',
    '00B6 dataDyne Building Extraction Blue blast shield',
    '00B7 dataDyne Building Light switch',
    '00B8 Investigation Sector Four Door (Top half)',
    '00B9 Investigation Sector Four Door (Bottom half)',
    '00BA Area 51 Explodable container',
    '00BB Investigation Metal chair',
    '00BC Investigation Table',
    '00BD BETA Investigation Microscope',
    '00BE BETA Investigation Mainframe',
    '00BF Investigation Laboratory door',
    '00C0 Investigation Slide-up door from laboratory (Top half)',
    '00C1 Ammo crate',
    '00C2 Cassandra De Vries Necklace',
    '00C3 Temple Door',
    '00C4 Carrington Institute Blue Sofa (With mirror image)',
    '00C5 Carrington Institute Lift',
    '00C6 Carrington Institute Glass door (Lift, Firing Range)',
    '00C7 Laser beam',
    '00C8 Skedar shuttle',
    '00C9 BETA Villa Pane of glass with wooden frame',
    '00CA Skedar Ruins Ceiling pillar/stone block',
    '00CB Skedar Ruins Ceiling pillar/stone block',
    '00CC Skedar Ruins Statue relic from last boss',
    '00CD Skedar Ruins Statue relic from last boss',
    '00CE Skedar Ruins Statue relic from last boss',
    '00CF Skedar Ruins Statue relic from last boss',
    '00D0 Skedar Ruins Statue relic from last boss',
    '00D1 Skedar Ruins Shaded floor piece (Centre part)',
    '00D2 Skedar Ruins Shaded floor piece (Middle left part)',
    '00D3 Skedar Ruins Shaded floor piece (Middle right part)',
    '00D4 Skedar Ruins Shaded floor piece (Base left part)',
    '00D5 Skedar Ruins Shaded floor piece (Base right part)',
    '00D6 Skedar Ruins Unshaded floor piece (Centre part)',
    '00D7 Skedar Ruins Unshaded floor piece (Middle left part)',
    '00D8 Skedar Ruins Unshaded floor piece (Middle right part)',
    '00D9 Skedar Ruins Unshaded floor piece (Base left part)',
    '00DA Skedar Ruins Unshaded floor piece (Base right part)',
    '00DB Skedar Ruins Pillar 1',
    '00DC Skedar Ruins Pillar 2',
    '00DD Skedar Ruins Pillar 3',
    '00DE Skedar Ruins Shaded floor piece',
    '00DF Skedar Ruins Shaded wall piece',
    '00E0 Skedar Ruins Unshaded floor piece',
    '00E1 Skedar Ruins Unshaded wall piece',
    '00E2 Metal barrel',
    '00E3 Grid Glass floor',
    '00E4 Air Base Escalator step',
    '00E5 Grid Lift',
    '00E6 Skedar Ruins Rubble 1 (Wall)',
    '00E7 Skedar Ruins Rubble 2 (Pillar)',
    '00E8 Skedar Ruins Rubble 3 (Stone)',
    '00E9 Skedar Ruins Rubble 4 (Small pillar)',
    '00EA Air Base Intro Cable car',
    '00EB Maian UFO',
    '00EC Air Base Stewardesses Bag',
    '00ED Air Base Small lift leading to hanger',
    '00EE Air Base Diagonal lift',
    '00EF Air Base Safe door',
    '00F0 Air Force One Pilots seat',
    '00F1 Air Force One Passenger seat',
    '00F2 BETA Chicago Limo',
    '00F3 Nightvision Goggles',
    '00F4 Shield',
    '00F5 Falcon 2',
    '00F6 Magsec 4',
    '00F7 Mauler',
    ...
    '010F Combat Knife',
    '0110 N-Bomb',
    '0111 BETA Flashbang (Grenade from GoldenEye)',
    '0112 Grenade',
    '0113 Timed Mine',
    '0114 Proximity Mine',
    '0115 Remote Mine',
    '0116 ECM Mine',
    '0117 PP9i (PP7)',
    '0118 CC13 (DD44) Dostovei.',
    '0119 KLO1313 (Klobb)',
    '011A KF7 Special (KF7 Soviet)',
    '011B ZZT (9mm) (ZMG (9mm))',
    '011C DMC (D5K) Deutsche',
    '011D AR53 (AR33) Assault Rifle',
    '011E RC-P45 (RC-P90)',
    '011F Rocket',
    '0120 Slayer Rocket',
    '0121 Bolt',
    '0122 Devastator Grenade',
    '0123 SuperDragon Grenade',
    '0124 Area 51 Infiltration Brown dronegun',
    '0125 Pelagic II Door with window',
    '0126 Area 51 AutoSurgeon',
    '0127 Chicago dataDyne limo',
    '0128 Area 51 Interceptor',
    '0129 Area 51 Parabola dish',
    '012A BETA Area 51 Radar console',
    '012B Area 51 Locker door',
    '012C BETA G5 Building Dampening field generator',
    '012D BETA G5 Building Dumpster',
    '012E Cloaking device',
    '012F Combat boost pills',
    '0130 Pelagic II Moon pool hanger door',
    '0131 Skedar Ruins piece of pillar rubble',
    '0132 Skedar Ruins piece of pillar rubble',
    '0133 Skedar Ruins piece of pillar rubble',
    '0134 Skedar Ruins piece of pillar rubble',
    '0135 Air Base Baggage carrier',
    '0136 BETA Area 51 Mine sign (With skull and crossbones on it)',
    '0137 Area 51 Maian coffin from cyrolabs',
    '0138 Investigation Radioactive isotope',
    '0139 Investigation Radioactive isotope parts',
    '013A BETA Reactor Door',
    '013B Crash Site Interior of Maian UFO',
    '013C Villa Stool that Carrington sits on',
    '013D Deep Sea Glass 1',
    '013E Deep Sea Glass 2 (Add-on)',
    '013F Deep Sea Glass 3 (Add-on opposite)',
    '0140 HorizonScanner',
    '0141 Pelagic II Outro Moon pool submarine',
    '0142 Air Force One (The actual plane)',
    '0143 Attack Ship Engine part',
    '0144 Deep Sea Ceiling dronegun',
    '0145 Deep Sea Small door',
    '0146 Deep Sea Switch node',
    '0147 BETA Deep Sea Door (Left)',
    '0148 BETA Deep Sea Door (Right)',
    '0149 Attack Ship Computer terminal from the bridge',
    '014A Attack Ship Computer terminal panel from the bridge',
    '014B Blue grating panel',
    '014C Carrington Institute Firing Range Target board',
    '014D Carrington Institute Device lab secret door',
    '014E Carrington Institute Carrington\'s office secret door',
    '014F Investigation dataDyne PC',
    '0150 Area 51 Records terminal (dataDyne PC on stand)',
    '0151 BETA Keypad lock',
    '0152 BETA Fingerprint scanner',
    '0153 BETA Retina lock',
    '0154 BETA Card lock',
    '0155 Air Force One Button on stand',
    '0156 Carrington Institute / Villa PC',
    '0157 Laptop Sentry dronegun',
    '0158 G5 Building Special Big chair',
    '0159 G5 Building Special Small chair',
    '015A Skedar Kings holy sceptre (Big King Rocket image)',
    '015B Area 51 Lab cloths',
    '015C BETA Carrington Institute Door',
    '015D G5 Building Special Chair',
    '015E G5 Building Special Small chair with top missing',
    '015F dataDyne Building Foyer pane of glass',
    '0160 BETA Carrington Institute Cabinet',
    '0161 BETA Carrington Institute Desk',
    '0162 BETA Carrington Institute Desk 2',
    '0163 BETA Carrington Institute Leather Armchair',
    '0164 BETA Carrington Institute Leather Bed',
    '0165 BETA Carrington Institute Leather Sofa',
    '0166 BETA Carrington Institute Table',
    '0167 Villa Coffee table',
    '0168 Villa Chair',
    '0169 BETA Villa Armchair',
    '016A Villa Sofa',
    '016B Villa Chair 2',
    '016C BETA Villa Cabinet with lamp',
    '016D Villa Side cabinet',
    '016E Villa Double bed',
    '016F BETA Pelagic II Chair',
    '0170 Attack Ship Computer console',
    '0171 BETA Investigation Table',
    '0172 BETA Investigation Chair',
    '0173 Air Base Table',
    '0174 BETA Air Base Chair',
    '0175 BETA White Box',
    '0176 Metal Crate',
    '0177 IR scanner googles',
    '0178 Area 51 Wall Dronegun',
    '0179 BETA Skedar Dronegun',
    '017A Carrington Institute Dronegun',
    '017B Villa Wooden table',
    '017C dataDyne Building Door',
    '017D BETA Air Base Door',
    '017E BETA Air Base Door 2',
    '017F Chicago Wire fence',
    '0180 Rareware logo',
    '0181 Keycard',
    '0182 BETA Body armor (Looks like the one from GoldenEye)',
    '0183 Area 51 Infiltration Inner area big slide door (Right)',
    '0184 Area 51 Infiltration Inner area big slide door (Left)',
    '0185 Air Force One Lamp',
    '0186 Air Force One Toilet',
    '0187 Air Force One Big door',
    '0188 Air Force One Phone',
    '0189 BETA Air Force One Cargo door',
    '018A G5 Building Alarm',
    '018B G5 Building Laser switch',
    '018C Skedar Ruins Pillar 4',
    '018D Pelagic II Power core hatch',
    '018E Area 51 Grate / Pane of glass with white stripes',
    '018F Air Force One Escape door',
    '0190 Presidential Escape Pod',
    '0191 Skedar Ruins Bridge',
    '0192 Pelagic II Door with no window',
    '0193 BETA Touch That Box, Box',
    '0194 Carrington Institute Front door',
    '0195 Laser',
    '0196 G5 Building BAFTA Award',
    '0197 Area 51 Rescue Outro Surgeons dissection laser',
    '0198 Crash Site Outro Elvis\'s hammer (Small size)',
    '0199 Area 51 Infiltration Explosives',
    '019A dataDyne Building Mr. Blonde\'s Revenge Skedar bomb',
    '019B Dr. Caroll\'s Backup disk',
    '019C Air Base Flight plans',
    '019D R-Tracker',
    '019E X-ray Scanner',
    '019F Crash Site Outro Elvis\'s hammer (Big size)',
    '01A0 Camspy, Drugspy, Bombspy',
    '01A1 Door Decoder',
    '01A2 Air Force One Table',
    '01A3 Air Base Air Force Ones private loader door',
    '01A4 Skedar Ruins Backdrop',
    '01A5 Carrington Institute Secret Device training door',
    '01A6 Carrington Institute Defense Sensitive information',
    '01A7 BETA Suitcase',
    '01A8 Skedar Ruins Push-block to activate bridge',
    '01A9 Area 51 Lift bars/door',
    '01AA Carrington Institute Switch',
    '01AB Attack Ship Blue door',
    '01AC Attack Ship Window',
    '01AD Attack Ship Hanger door (Top half)',
    '01AE Attack Ship Hanger door (Bottom half)',
    '01AF Air Force One Inner door',
    '01B0 BETA Laser post',
    '01B1 Skedar Ruins Target Amplifier',
    '01B2 Attack Ship Lift',
    '01B3 Carrington Institute Defense Smashed front door',
    '01B4 Deep Sea Slide-up door',
    '01B5 Air Force One Drop vent rubble',
    '01B6 dataDyne Building Small door / Felicity Door',
    '01B7 Deep Sea Slide door',
    '01B8 Skedar Ruins Buddy Bridge',
]

ModelNames_Items = [(e, e, e, idx) for idx, e in enumerate(ModelNames)]
